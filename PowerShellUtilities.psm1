...
Export-ModuleMember -Function Invoke-PCommand, Backup-File, Add-FileToRar, update-timestamp, Get-GUID,wait-ADReplication, Start-GuidedSleep, New-GeneratedPassword, Start-ADToAADSync
